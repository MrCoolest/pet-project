...
$query = $_GET['search'];
// echo $query;
$sql = "SELECT * FROM pet_posts WHERE (`Category` LIKE '%".$query."%') OR (`First_name` LIKE '%".$query."%') OR (`city` LIKE '%".$query."%') OR (`Last_name` LIKE '%".$query."%') OR (`State` LIKE '%".$query."%') OR (`Country` LIKE '%".$query."%')";
...
if ($result->num_rows > 0) {
   ...
   echo '<div class="card mb-3">
        ...
        <div class="card-body">
          ...
          <p class="card-text desc-size">'.$row["Description"].'</p>';
